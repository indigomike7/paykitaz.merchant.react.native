...
//      
var warning = process.env.NODE_ENV === 'production' ?
...
var Html5ValidationField$1 = forwardRef(function (props, ref) {
  return createElement(Html5ValidationField, _extends({
    innerRef: ref
  }, props));
});

export { Html5ValidationField$1 as Field };
